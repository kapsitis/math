...
* _hasSolutionConcept: IrrationalAndReals, VariableExpression, QuadraticEquation, SquareOfSumIdentity, CaseAnalysis
...
* _hasSolutionConcept: Triangle, TriangleSimilarity, ParallelPerpendicular, PointLineSegmentRay
...
* _hasSolutionConcept: PerfectSquares, DigitSum, DivisibilityRules, DivisibilityRelation
...
* _hasSolutionConcept: LatticeGrid, ChessboardColoring, Invariant, OptimumProofStructure
...
* domain:
* _subdomain: DOM_CombinatorialStructures
* _hasSolutionConcept: GraphConcept, VariableExpression, Invariant
...
* _hasSolutionConcept: PrimeNumbers, EvenOddParity, NumberPartitions, PositiveIntegers
...
* _hasSolutionConcept: PositiveIntegers, DivisionWithRemainder, ModularArithmetic, PerfectSquares
...
* _hasSolutionConcept: GraphConcept, VertexDegree, OptimumProofStructure, ProofByContradiction
...
* _hasSolutionConcept: NumberSequence, RationalNumbers, ArithmeticMean, TotalOrder
...
* _subdomain: DOM_Graphs
* _hasSolutionConcept: GraphConcept, PigeonholePrinciple, FiniteSet
...
* _hasSolutionConcept: CircleAndDisk, ChordTangentSecant, InscribedCentralAngle, ParallelPerpendicular, Triangle
...
* domain:NT
* _subdomain: DOM_SpecialNumbers
* _hasSolutionConcept: PerfectSquares, DivisionWithRemainder, CaseAnalysis, ProofByContradiction
...
* _hasSolutionConcept: PositiveIntegers, NumberSequence, FibonacciLikeSequence, LinearDiophantine
...
* _hasSolutionConcept: WholeIntegers, Triangle, TriangleSpecialLines, DivisibilityRelation, ModularArithmetic, PigeonholePrinciple
...
* _hasSolutionConcept: PolynomialAndRoots, VietasFormulas, PositiveIntegers
...
* domain:
* _subdomain: DOM_CirclesAndRelatedAngles
* _hasSolutionConcept: CircleAndDisk, ChordTangentSecant, Triangle, PythagoreanTheorem
...
* domain:NT
* _subdomain: DOM_SpecialNumbers
* _hasSolutionConcept: PositiveIntegers, PerfectSquares, ModularArithmetic, PeriodicSequence
...
* method:MTH_PigeonholePrincipleBasic
* _subdomain: DOM_NumberRepresentation
* _hasSolutionConcept: IrrationalAndReals, GraphConcept, PigeonholePrinciple, ProofByContradiction
...
* _hasSolutionConcept: PositiveIntegers, EvenOddParity, PrimeNumbers, DivisibilityRelation, CoprimeIntegers, FrobeniusType
