...
* _hasSolutionConcept: QuadraticFunction, QuadraticEquation, PolynomialAndRoots, OptimumProofStructure
...
* _hasSolutionConcept: DivisionWithRemainder, PigeonholePrinciple, CaseAnalysis
...
* _hasSolutionConcept: LatticeGrid, GraphConcept, FiniteSet, Invariant, ProofByContradiction
...
* domain:
* _subdomain: DOM_Area
* _hasSolutionConcept: Triangle, TriangleSpecialLines, PythagoreanTheorem, TriangleCongruence, TriangleSimilarity
...
* _hasSolutionConcept: FiniteSequenceArrangement, Invariant, SetPartition
...
* _hasSolutionConcept: WholeIntegers, EquationSystem, LinearInequality, QuadraticFunction, CaseAnalysis, ExhaustiveCheck
...
* _hasSolutionConcept: ParallelogramProperties, Triangle, TriangleSimilarity, PythagoreanTheorem, TriangleSpecialLines
...
* _hasSolutionConcept: PositiveIntegers, DivisibilityRelation, DigitSum, DigitRepresentation, ArithmeticProgression
...
* _hasSolutionConcept: GraphConcept, VertexDegree, HandshakeLemma, ExistenceVsUniversal, Counterexample
...
* _hasSolutionConcept: PositiveIntegers, UnorderedSelection, FiniteSet, PigeonholePrinciple, ProofByContradiction
...
* _hasSolutionConcept: PositiveAndNegative, VariableExpression, LinearInequality, CaseAnalysis, FunctionConcept
...
* _hasSolutionConcept: Triangle, ParallelPerpendicular, TriangleSpecialLines, TriangleSimilarity
...
* _hasSolutionConcept: PositiveIntegers, DigitSum, DivisibilityRelation, DivisibilityRules, ArithmeticProgression
...
* _hasSolutionConcept: EquationSystem, PolynomialAndRoots, FunctionConcept
...
* domain:
* _subdomain: DOM_MakingMoves
* _hasSolutionConcept: Invariant, DivisibilityRelation, PositiveIntegers
...
* _hasSolutionConcept: VariableExpression
...
* domain:
* _subdomain: DOM_MetricRelations
* _hasSolutionConcept: Triangle, TriangleSpecialLines, TriangleSimilarity, ParallelPerpendicular
...
* _hasSolutionConcept: WholeIntegers, PerfectCubes, PerfectSquares, CaseAnalysis, ProofByContradiction
...
* _hasSolutionConcept: DivisibilityRelation, Tiling, Coloring, Invariant
...
* _hasSolutionConcept: PositiveIntegers, DivisionWithRemainder, StateSpaceProcess, Monovariant
