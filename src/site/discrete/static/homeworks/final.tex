...
\begin{figure}[!htb]
\center{\includegraphics[width=2in]{final-syntax-tree.png}}
...
{\bf Question 10.}\\
\begin{figure}[!htb]
\center{\includegraphics[width=2in]{prim-weighted-graph.png}}
...
\begin{figure}[!htb]
\center{\includegraphics[width=2in]{prim-weighted-mst.png}}
