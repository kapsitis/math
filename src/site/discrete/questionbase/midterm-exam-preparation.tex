...
\begin{figure}[!htb]
\center{\includegraphics[width=2in]{midterm-exam-preparation/midterm-syntax-tree.png}}
...
\begin{figure}[!htb]
\center{\includegraphics[width=2in]{midterm-exam-preparation/predicate-grid.png}}
...
\begin{figure}[!htb]
\center{\includegraphics[width=3in]{midterm-exam-preparation/arithmetic-sequences.png}}
...
\begin{figure}[!htb]
\center{\includegraphics[width=2in]{midterm-exam-preparation/bounded-function.png}}
