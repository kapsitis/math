function main() {
    ...
    var getAsterisk = function() {
        ...
        theP.setAttribute("style","position:absolute;top:25px;right:30px;z-index:1;");
    ...
    var getLogo = function() {
        var theP = document.createElement("p");
        theP.setAttribute("style","position:absolute;top:20px;left:20px;z-index:1;");
