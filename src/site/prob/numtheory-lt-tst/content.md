...
<hgroup style="font-size:65%; width:60%">
...
* **LT.VILNIUS** - Vilniaus miesto olimpiada (Viļņas pilsētas olimpiāde)
...
* <blue>**LT.TST** - **Atrankos (Atlases sacensības)**</blue>
...
Vai Mīkolas varēja izvēlēties sākotnējo virkni $a_1, a_2, a_3,\ldots$ tādā veidā, 
...
Naturālu skaitli $n$ sauksim par *piecdaļīgu*, ja tam ir 
tādi pieci dažādi pozitīvi dalītāji, kuru ceturto pakāpju summa vienāda ar $n$. 
(Skaitļi $1$ un $n$ arī ir  skaitļa $n$ dalītāji.)  
**(a)** Pierādiet, ka piecdaļīgs skaitlis vienmēr dalās ar $5$.  
**(b)** Noskaidrojiet, vai ir bezgalīgi daudz piecdaļīgu naturālu skaitļu.
